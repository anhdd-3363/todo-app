...
<template>
  <div
    class="max-w-screen-lg mx-auto flex flex-col items-center justify-center"
  >
    ...
    <div class="rounded-lg border-2 p-5 w-96">
      <div class="flex items-center justify-center mb-3">
        ...
        <button
          ...
          :class="
            !newTodo ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-500'
          "
          @click="handleAdd"
          :disabled="!newTodo"
        >
    ...
    <div class="w-96 mt-10">
      <p class="text-xl text-center">Count: {{ counter.count }}</p>
    </div>
  </div>
</template>
